...
## Project Structure
    ...
    ├── testapiautostoryboa_62763  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_62763`
...
2. Clone this repo and `cd testapiautostoryboa_62763`
